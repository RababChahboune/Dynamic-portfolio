...
<%
    ArrayList<Domaine> d = (ArrayList<Domaine>) request.getAttribute("domaine");
    Portfolio p = ((Administrateur) request.getAttribute("administrateur")).getPortfolio();
%>
<html>
<head>
    ...
    <script src="<%=request.getContextPath()%>/lib/dist/js/admin/information.js"></script>
            ...
            <div class="row">
                    ...
                    <div class="box box-warning">
                        <div class="box-body box-profile">
                            <img class="profile-user-img img-responsive img-"
                                 src="<%=request.getContextPath()%>/lib/dist/img/portfolio/<%=p.getLogoPortfolio()%>" alt="User profile picture">
                ...
                <div class="col-md-8">
                    <div class="box box-warning">
                        ...
                        <form method="POST" action="<%=request.getContextPath()%>/portfolioController"  enctype="multipart/form-data">
                            <div class="box-body">
