...
<%
    ArrayList<Courrier> list = (ArrayList<Courrier>) request.getAttribute("courrier");
%>
<html>
<head>
    ...
    <script src="<%=request.getContextPath()%>/lib/dist/js/admin/courrier.js"></script>
</head>
