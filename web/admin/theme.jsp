...
<%
    ...
    ArrayList<Theme> themes = (ArrayList<Theme>) request.getAttribute("theme");
    String selectedThemeImage = (String) request.getAttribute("selectedThemeImage");
%>
...
<head>
    ...
    <script src="<%=request.getContextPath()%>/lib/dist/js/admin/theme.js"></script>
</head>
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="with-border border-right col-md-12">
                                        ...
                                        <img id="themeImg" class="img-responsive" src="<%=request.getContextPath()%>/lib/dist/img/theme/<%=selectedThemeImage%>" alt="Photo">
                                    </div>
