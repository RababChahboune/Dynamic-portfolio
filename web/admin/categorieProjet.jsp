...
<%
    Categorie_projet cp = (Categorie_projet) request.getAttribute("cat");
...
<head>
    ...
    <script src="<%=request.getContextPath()%>/lib/dist/js/admin/catProjet.js"></script>
</head>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <div class="col-md-12">
                        <form method="POST" action="<%=request.getContextPath()%>/catProjectController"  enctype="multipart/form-data">
