        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 text-center">
                <div class="service-box">
                    <img src="../lib/dist/img/profile/<% if(!profile.getImageProfile().equals("0")) out.print(profile.getImageProfile()); else out.print("default.png");%>" width="100">
                    <h2><%=profile.getNomProfile()+" "+profile.getPrenomProfile()%></h2>
                </div>
            </div>
            <%}%>
        </div>
        ...
        <div class="row no-gutter popup-gallery">
            ...
            <div class="col-lg-4 col-sm-6">
                <a href="../lib/dist/img/projet/<% if(!projet.getImageProjet().equals("0")) out.print(projet.getImageProjet()); else out.print("default.png");%>" class="portfolio-box">
                    <img src="../lib/dist/img/projet/<% if(!projet.getImageProjet().equals("0")) out.print(projet.getImageProjet()); else out.print("default.png");%>" class="img-responsive" alt="">
